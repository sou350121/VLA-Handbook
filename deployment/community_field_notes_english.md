...
> **版本**: v3.9 — 2026-05-29（新增 #186-#197：GR00T N1.7 + EgoScale dexterity scaling law、LeRobot Humanoid $2,500 双足、Figure Helix-02 8h+17h+40h 工厂直播、NVIDIA Cosmos 3、VLA-Perf 推理性能建模、PhysiFlow 多脑 flow matching、CF-VLA coarse-to-fine、How VLAs (Really) Work 开放世界批判、LIBERO-PRO v2 更新、MotuBrain 长 horizon 配方、HandITL 灵巧 HITL、FASTER 实时 flow VLA）
> **上版**: v3.8 — 2026-04-24（#174-#185：SnapFlow、National Robotics Week、mimic-video、VLA Foundry、VLAJS、HEX、COIN、OneVL、1X Redwood AI、LeRobot Hackathon、Dexora、E-VLA）
