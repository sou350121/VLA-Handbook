...
> **版本**: v3.7 — 2026-04-17（新增 #166-#173：π0.7 steerable、Gemini Robotics-ER 1.6、RLT、MEM、HF Spring 2026、Cosmos Reason 2、GR00T N1.6 on AGX Orin、ViVa value model）
...
*v3.7 — 2026-04-17 更新。Blog 173 条（#1-#173）+ Discord 154 条（D1-D154），共 327 条。v3.7 新增：#166 π0.7 Steerable Model（PI 2026-04-16，组合泛化 + 零样本 UR5e 双臂折叠匹配 375h 专家）、#167 Gemini Robotics-ER 1.6（DeepMind 2026-04-15，仪表读数 23%→93%）、#168 RLT（PI 2026-03-19，lightweight RL token）、#169 MEM（PI 2026-03-03，>10min 长任务多尺度记忆）、#170 HF Spring 2026（机器人数据集 1145→26991，23× 增长成 Hub #1）、#171 Cosmos Reason 2（NVIDIA，16K→256K context，Physical AI Bench #1）、#172 GR00T N1.6 on AGX Orin 64G（Seeed Wiki，微调需 48GB+ VRAM）、#173 ViVa（arXiv 2604.08168，视频生成器转 value model）。*
