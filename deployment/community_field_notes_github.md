...
## 7. 框架采纳度信号（2026-05-29 快照）

| 框架 | 7d Issues | 采纳阶段 | DFI | 信号 |
|------|-----------|---------|-----|------|
| **isaaclab** | 48 | 早期探索 | 0.06 (low) | 主要摩擦: install |
| **lerobot** | 27 | 早期探索 | 0.04 (low) | 主要摩擦: hardware |
| **gr00t** | 7 | 早期探索 | 0.10 (low) | 主要摩擦: deploy |
| **genesis** | 5 | 混合 | 0.00 (low) | 主要摩擦: deploy |
| **openpi** | 4 | 混合 | 0.06 (low) | 主要摩擦: hardware |
| **maniskill** | 3 | 开发整合 | 0.05 (low) | 主要摩擦: train |
| **mujoco** | 3 | 混合 | 0.00 (low) | 主要摩擦: deploy |
| **openvla** | 1 | 混合 | 0.00 (low) | 主要摩擦: deploy |
| **magma** | 1 | 混合 | 0.25 (low) | 主要摩擦: hardware |
...
> 数据来源: Pulsar GitHub Issues Sensor, 99 issues analyzed in 7-day window
