...
## 7. 框架采纳度信号（2026-03 快照）

| 框架 | 7d Issues | 采纳阶段 | 信号 |
|------|-----------|---------|------|
| **lerobot** | 63 | 开发活跃 | 训练+数据问题主导；SmolVLA 新增大量用户 |
| **ManiSkill** | 32 | 开发活跃 | 灵巧手+运动规划问题集中 |
| **GR00T** | 26 | 早期采纳 | 安装问题 33%；官方 checkpoint 信任危机 |
| **IsaacLab** | 22 | 活跃使用 | URDF 导入回归引发大量投诉 |
| **mujoco** | 22 | 成熟稳定 | 基础设施级，问题多为 API 使用 |
| **Genesis** | 7 | 快速增长 | 28K 星但 Issues 少 = 用户多但大多观望 |
| **openpi** | 6 | 训练探索 | 微调问题主导；部署尝试开始 |
| **openvla** | 2 | **衰退** | 几乎无活动，正被 pi0/lerobot 取代 |
