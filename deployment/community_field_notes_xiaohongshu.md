...
> **来源**：260+ 篇小红书 + 中文社区帖子（帖1-171 + 可追溯索引 230 条），2026-03-14 起持续收集
...
*本文件由定时收集器自动更新（v2，帖 1-171 + 可追溯索引 230 条，共 260+ 条）。原始数据和方法论详见 [收集流程复盘](../../memory/blog/archives/xiaohongshu-community/workflow-and-automation.md)。*
