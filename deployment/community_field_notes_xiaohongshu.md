...
*本文件由定时收集器自动更新（v2.4，帖 1-290 + 可追溯索引 40 条 + 黑话辞典 28 条，共 390+ 条）。最近更新：2026-06-01 Round 4（6 关键词 / 7 篇 工程 bug + insider + 反直觉，详见 §15.10）。原始数据和方法论详见 [收集流程复盘](../memory/blog/archives/xiaohongshu-community/workflow-and-automation.md)。*
