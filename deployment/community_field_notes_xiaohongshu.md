...
> **来源**：383+ 条小红书社区蒸馏（帖1-283 + 可追溯索引 40 条 + 黑话辞典 28 条），2026-03-14 起持续收集
...
> **更新频率**：每 3 天自动增量收集（最近一次：2026-06-01 Round 3 一手参数 / 踩坑，详见 §15.9）（最近一次：2026-05-29 三轮，详见 §15）
>
...
*本文件由定时收集器自动更新（v2.3，帖 1-283 + 可追溯索引 40 条 + 黑话辞典 28 条，共 383+ 条）。最近更新：2026-06-01 Round 3（7 关键词 / 7 篇一手参数/踩坑帖，详见 §15.9）。原始数据和方法论详见 [收集流程复盘](../memory/blog/archives/xiaohongshu-community/workflow-and-automation.md)。*
