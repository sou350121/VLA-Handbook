...
> 2026-04-21 · 🚨 **报单一 benchmark 分数要慎重**——所有 LIBERO 系列都有记忆化风险
...
**充分**：
> "LIBERO 标准 97.2%，LIBERO-PRO 泛化设定 **32.5%**——差距说明模型学到一部分模式，但在新物体/新位置下仍脆弱。已对 **vision-only baseline** 做消融，成功率从 95% 跌到 44%，说明语言确实起作用。"

—— 多一组扰动数据 + 消融信号，可信度完全不一样。
