...
| **NVIDIA Physical AI × 自动驾驶（2026）** | [`./frontier/nvidia_physical_ai_autonomous_driving_2026.md`](./frontier/nvidia_physical_ai_autonomous_driving_2026.md) | 🆕 自动驾驶为何成了 NVIDIA Physical AI 的第一块试验田：teacher model + 开放数据 + 闭环仿真 + Halos 安全体系 + DRIVE 车端部署 |
